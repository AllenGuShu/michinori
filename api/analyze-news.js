...
const CATEGORIES = ["政治・社會", "經濟・商業", "天氣・災害", "社會・生活", "交通・觀光", "運動", "科技", "文化・娛樂", "健康・醫療", "其他"];
...
5. 挑選5到8個對日文學習者實用的重點單字，每個單字都要判斷：
   (a) JLPT難度等級，只能是 N5、N4、N3、N2、N1 其中一個
   (b) 分類，只能從這幾個選一個：${CATEGORIES.join("、")}
6. 分析文章中出現的2到4個文法句型，並各自附上文章中的原句當例句，同樣要判斷JLPT難度等級（N5～N1其中一個）。
...
回傳格式（純JSON，不要其他文字，不要markdown code block）：
{
  ...
  "vocab": [{"word":"漢字或原文","reading":"假名讀音","zh":"中文意思","level":"N4","category":"社會・生活"}],
  "grammar": [{"pattern":"句型","meaning":"中文語意","note":"用法說明","example":"文章中的例句(含假名標註)","exampleZh":"例句中文翻譯","level":"N3"}],
